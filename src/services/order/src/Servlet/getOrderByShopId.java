...
//@WebServlet("/getOrderByShopId")
public class getOrderByShopId extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public getOrderByShopId() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
        	...
        	os = new OrderService();
        	info = os.queryOrderByShopId(shopId, index, limit);
        	if(info == null) {
